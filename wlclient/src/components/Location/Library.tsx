...
const actions: Record<string, PlayerAction> = {
    ...
    [Actions.specificActions.LIBRARY.EXPLORE]: {
        description: 'Talk to the librarians about the Marine Library.',
        task: 'Use 5 minutes of Oxygen.',
    },
    [Actions.specificActions.LIBRARY.STUDY_CRIMSON]: {
        description:
            'Learn more about the Crimson, a crisis that took place 10,000 years ago.',
        task:
    ...
    [Actions.specificActions.LIBRARY.STUDY_ARTEFACT]: {
        description: 'Learn more about the artefacts.',
        task: 'Create a new group cheer and do it to energise yourselves.',
    },
    [Actions.specificActions.LIBRARY.DECODE_ARTEFACT]: {
        description:
