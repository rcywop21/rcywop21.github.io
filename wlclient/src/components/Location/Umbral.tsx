...
const actions: Record<string, PlayerAction> = {
    ...
    [Actions.specificActions.UMBRAL.EXPLORE]: {
        description:
    ...
    [Actions.specificActions.UMBRAL.GIVE_PAN]: {
        description: 'Give Alyusi the Pyrite Pan.',
        task: 'Give 1 x Pyrite Pan.',
    },
    [Actions.specificActions.UMBRAL.GIVE_ROCK]: {
        description: 'Give Alyusi the Chmyrrkyth.',
