...
const actions: Record<string, PlayerAction> = {
    ...
    [Actions.ALL_UNDERWATER.WITHDRAW_OXYGEN]: { description: "Withdraw all Oxygen from your Oxygen Pump.", 
                                                task: "No task required."},
    [Actions.ALL_OXYGEN.GET_OXYGEN]: { description: "The Bubble Factory is one of the largest source of Oxygen in the Undersea. However, you will need a Bubble Pass to be able to get Oxygen here. You can get 60 minutes of Oxygen here.", 
                                       task: "Each of you has to show a different item from the following: Pencil case, phone application and items you bring on a holiday"},
}
