...
const actions: Record<string, PlayerAction> = {
    ...
    [Actions.specificActions.STATUE.EXPLORE]: {
        description:
    ...
    [Actions.specificActions.STATUE.POWER_CONTAINMENT]: {
        description:
    ...
    [Actions.specificActions.STATUE.PURIFY_CORRUPTION]: {
        description:
