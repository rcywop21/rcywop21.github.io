...
const actions: Record<string, PlayerAction> = {
    ...
    [Actions.specificActions.STORE.BUY_DOLL]: {
        description: "It's a doll of The Little Mermaid! How cute UWU.",
        task: 'Pay 10 minutes of Oxygen to receive 1 x Mermaid Doll.',
    },
    [Actions.specificActions.STORE.BUY_DISCOVERS]: {
        description:
    ...
    [Actions.specificActions.STORE.BUY_PUMP]: {
        description:
    ...
    [Actions.specificActions.STORE.BUY_BLACK_ROCK]: {
        description:
    ...
    [Actions.specificActions.STORE.BUY_BUBBLE_PASS]: {
        description:
