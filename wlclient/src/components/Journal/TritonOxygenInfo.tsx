...
const TritonOxygenInfo = (props: TritonOxygenInfoProps): React.ReactElement => {
    ...
    const lastTeam =
        tritonOxygen.lastTeam === undefined
            ? 'an unknown person'
            : 'Team ' + tritonOxygen.lastTeam.toString();
        ...
        <OxygenEntry
            ...
            addendum={
                <div className="addendum">
                    The Statue of Triton has accumulated{' '}
                    {Util.formatDuration(availableOxygen)} of Oxygen. It was
