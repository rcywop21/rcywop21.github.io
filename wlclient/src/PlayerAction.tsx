...
export type DescriptionPredicate = (playerState: PlayerState, globalState?: GlobalState) => string;
...
export class PlayerAction {
    ...
    isVisible: boolean;
    isEnabled: boolean;
    constructor(display: string, description: string, task: string, x: string, y: string,
                optionalDescription?: DescriptionPredicate, visibility?: StatePredicate, enabled?: StatePredicate) {
...
export class DynamicPlayerAction extends PlayerAction {
    ...
    constructor(display: string, description: string, task: string, x: string, y: string,
                timeToCompare: (ps: PlayerState) => Date, howRecentToTrigger: number,
                triggerEffectsIfRecent: (v: ((b: boolean) => void), e: ((b: boolean) => void)) => void,
                triggerEffectsIfNotRecent: (v: ((b: boolean) => void), e: ((b: boolean) => void)) => void,
                optionalDescription?: DescriptionPredicate, visibility?: StatePredicate, enabled?: StatePredicate) {
        super(display, description, task, x, y, optionalDescription, visibility, enabled);
...
export const makeActionProps = (actions: Record<string, PlayerAction>, isMentor: boolean | undefined, playerState: PlayerState, handleAction: ActionHandlerCreator, triggerTooltip: TooltipTrigger, globalState?: GlobalState): ActionProps[] => Object.entries(actions)
...
export const makeDynamicActionProps = (actions: Record<string, PlayerAction>, isMentor: boolean | undefined, playerState: PlayerState, handleAction: ActionHandlerCreator, triggerTooltip: TooltipTrigger, globalState?: GlobalState): DynamicActionProps[] => Object.entries(actions)
    .filter(([, playerAction]) => (playerAction instanceof DynamicPlayerAction))
    .map(([actionId, playerAction]) => {
...
const coolDownMessage = (playerState: PlayerState) => playerState.streamCooldownExpiry[playerState.locationId]
    ? " You may reuse this service again at " + new Date(playerState.streamCooldownExpiry[playerState.locationId]).toLocaleTimeString() + "."
    : "";

const lastUsedMessage = (playerState: PlayerState, globalState: GlobalState) => {
...
export const allPlayerActions = {
    [Locations.locationIds.ALCOVE]: {
        ...
        [Actions.ALL_UNDERWATER.WITHDRAW_OXYGEN]: new PlayerAction("Withdraw Oxygen", "Withdraw all Oxygen from your Oxygen Pump.", 
            "No task required.", "870px", "543px", undefined,
            (playerState) => playerState.storedOxygen !== null && playerState.challengeMode !== null),
    ...
    [Locations.locationIds.ANCHOVY]: {
        ...
        [Actions.specificActions.ANCHOVY.INSPIRE]: new PlayerAction("Inspire", "Inspire the Chief Librarian with your leadership!", 
            "Have any member of your team perform Project Inspire.", "294px", "533px", undefined,
    ...
    [Locations.locationIds.BARNACLE]: {
        [Actions.specificActions.BARNACLE.EXPLORE]: new DynamicPlayerAction("Explore", "Barnacle Residences is a residential district. The Pyrite Lady is said to live here.", 
            ...
            (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; },),
        [Actions.specificActions.BARNACLE.HELP]: new PlayerAction("Help", "The Pyrite Lady has mixed up some of her potion ingredients. Help her!", 
            "Create a list of youngest to oldest of your whole group.", "437px", "471px", undefined,
    ...
    [Locations.locationIds.CATFISH]: {
        ...
        [Actions.ALL_OXYGEN.GET_OXYGEN]: new DynamicPlayerAction("Get Oxygen", "The Oxygen Stream at Catfish Crescent is curiously linked with the one located at Salmon Street. Both need to be activated at roughly the same time, before you can receive 40 minutes of Oxygen.", 
    ...
    [Locations.locationIds.CORALS]: {
        ...
        [Actions.specificActions.CORALS.LEARN_LANG]: new PlayerAction("Learn Language", 
            ...
            "427px", "419px", undefined, (playerState) => playerState.quests[questIds.FINCHES]?.status === 'incomplete',
        ...
        [Actions.ALL_OXYGEN.GET_OXYGEN]: new DynamicPlayerAction("Get Oxygen", "There is a small oxygen stream at the Memorial Corals. By Undersea law, after topping up Oxygen, you must wait 10 minutes before you can top up Oxygen at the same Oxygen Stream.", 
            "Each person has to present a fully filled water bottle to the mentors to receive 20 minutes of Oxygen.", "108px", "438px",
            (playerState) => playerState.streamCooldownExpiry[playerState.locationId] ? new Date(playerState.streamCooldownExpiry[playerState.locationId]) : new Date(0),
            0, (setIsVisible, setIsEnabled): void => { setIsEnabled(true);}, (setIsVisible, setIsEnabled): void => { setIsEnabled(false);},
            coolDownMessage)
    },
    [Locations.locationIds.KELP]: {
        ...
        [Actions.specificActions.KELP.CLIMB_DOWN]: new PlayerAction("Climb Down Valley", "You have found a small shrine tucked away in a valley. However, the journey there looks difficult.", 
            "Online Maze: https://www.mathsisfun.com/games/mazes.html. Complete one Hard maze.", "360px", "487px", undefined,
    ...
    [Locations.locationIds.LIBRARY]: {
        ...
        [Actions.specificActions.LIBRARY.STUDY_ARTEFACT]: new PlayerAction("Study Artefact Legends", "Learn more about the artefacts.", 
            "Create a new group cheer and do it to energise yourselves.", "630px", "202px", undefined,
        ...
        [Actions.specificActions.LIBRARY.DECODE_ARTEFACT]: new PlayerAction("Decode Artefact", "The artefact legend is written in an ancient language. You will need to decode it before you can understand it.", 
            "Decode 'Hwljaxawv Ljalgf'.", "703px", "265px", undefined,
    ...
    [Locations.locationIds.SALMON]: {
        [Actions.specificActions.SALMON.EXPLORE]: new DynamicPlayerAction("Explore", "Salmon Street is a residential district. It was built around an Oxygen Stream located here.", 
            ...
            (playerState) => playerState.oxygenUntil ? new Date(playerState.oxygenUntil) : new Date(0),
            300000, (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; },),
        [Actions.specificActions.SALMON.CONFRONT]: new PlayerAction("Confront", "The children are chasing each other with a long and pointy stick. Tell them what is right.", 
            "Have any member of your team perform Project MTW.", "142px", "542px", undefined,
        ...
        [Actions.ALL_OXYGEN.GET_OXYGEN]: new DynamicPlayerAction("Get Oxygen", "The Oxygen Stream at Salmon Street is curiously linked with the one located at Catfish Crescent. Both need to be activated at roughly the same time, before you can receive 40 minutes of Oxygen.", 
    ...
    [Locations.locationIds.SHRINE]: {
        ...
        [Actions.specificActions.SHRINE.COLLECT_HAIR]: new PlayerAction("Collect Tear", "Collect the Unicorn Tear from the Shrine.", 
            "Receive 1 x Unicorn Tear.", "434px", "495px", undefined,
    ...
    [Locations.locationIds.STATUE]: {
        ...
        [Actions.specificActions.STATUE.DECODE_ENGRAVING]: new PlayerAction("Decode Engraving", "You have found an engraving written in the ancient language. Decode it to learn what it says.", 
            "Decode 'Vwwh Ujaekgf'", "250px", "553px", undefined,
        ...
        [Actions.specificActions.STATUE.CAST_COOLING_AURA]: new PlayerAction("Cast Cool Aura", "The Crimson's body temperature is kept low as part of its slumber. Prevent it from getting too high!",
            "Water Parade.", "414px", "324px", undefined,
        ...
        [Actions.specificActions.STATUE.STRENGTHEN_BEFUDDLEMENT]: new PlayerAction("Befuddle Harder", "A Befuddlement Spell keeps the Crimson from waking up. However, it may weaken over time, and you will have to strengthen it.",
            "Do 10 Jumping Jacks/Buddha Claps.", "125px", "122px", undefined,
            (playerState) => playerState.knowsCrimson,
            (playerState) => playerState.quests[questIds.CHAPTER_3]?.status === 'incomplete'),
        [Actions.specificActions.STATUE.POWER_CONTAINMENT]: new PlayerAction("Contain Power", "The Containment Arrays attempt to isolate the Crimson so that it doesn't sense the artefacts and awaken. You will need to power it to keep the isolation secure.",
            "Everyone to present a different battery brand/type (including portable batteries).", "376px", "135px", undefined,
            (playerState) => playerState.knowsCrimson,
            (playerState) => playerState.quests[questIds.CHAPTER_3]?.status === 'incomplete'),
        [Actions.specificActions.STATUE.PURIFY_CORRUPTION]: new PlayerAction("Purify Corruption", "As the Crimson begins to awaken, it will start to corrupt the surroundings. It draws even more power from this corruption. You will need to purify the corruption to keep the Crimson weak.",
            "Everyone to present a hand sanitiser of different brands.", "100px", "304px", undefined,
            (playerState) => playerState.knowsCrimson,
            (playerState) => playerState.quests[questIds.CHAPTER_3]?.status === 'incomplete'),
        [Actions.ALL_UNDERWATER.STORE_OXYGEN]: new PlayerAction("Store Oxygen", "Store all your Oxygen (except 2 mins, enough for you to resurface) into your Oxygen Pump.", 
            "No task required.", "870px", "488px", undefined,
        ...
        [Actions.ALL_OXYGEN.GET_OXYGEN]: new DynamicPlayerAction("Get Oxygen", "The Statue of Triton has a publicly-accessible storage of Oxygen, which slowly builds up 4 minutes of Oxygen every minute. You can get all the Oxygen inside this store. Note that this storage is shared between everyone.", 
            "Conduct a Water Parade (skip if fasting) to receive all Oxygen stored at the statue.",
            "826px", "238px", (playerState) => playerState.streamCooldownExpiry[playerState.locationId] ? new Date(playerState.streamCooldownExpiry[playerState.locationId]) : new Date(0),
            0, (setIsVisible, setIsEnabled): void => { setIsEnabled(true);}, (setIsVisible, setIsEnabled): void => { setIsEnabled(false);},
    ...
    [Locations.locationIds.STORE]: {
        [Actions.specificActions.STORE.BUY_MAP]: new DynamicPlayerAction("Buy Map", "This map will let you find your way to more locations in the Undersea.", 
            ...
            (): void => { return; }, undefined, (playerState) => !playerState.inventory['Map'],
        ),
        [Actions.specificActions.STORE.BUY_GUIDE]: new DynamicPlayerAction("Buy Guide", "It's an introduction of all the Oxygen Streams in the Undersea.",
            ...
            300000,
            (setIsVisible, setIsEnabled): void => { setIsEnabled(false); },
            (): void => { return; }, undefined, (playerState) => !playerState.inventory['OxygenGuide']),
        [Actions.specificActions.STORE.BUY_DOLL]: new DynamicPlayerAction("Buy Doll", "It's a doll of The Little Mermaid! How cute UWU.",
            ...
            (playerState) => playerState.oxygenUntil ? new Date(playerState.oxygenUntil) : new Date(0),
            600000, (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; }),
        [Actions.specificActions.STORE.BUY_DISCOVERS]: new DynamicPlayerAction("Buy Ticket", "This ticket lets you go on the full tour of the Statue of Triton.", 
            ...
            (playerState) => playerState.oxygenUntil ? new Date(playerState.oxygenUntil) : new Date(0),
            1200000, (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; }),
        [Actions.specificActions.STORE.BUY_PUMP]: new DynamicPlayerAction("Buy Pump", "This pump allows you to store all your Oxygen before you resurface, so it doesn't go to waste.", 
            ...
            (playerState) => playerState.oxygenUntil ? new Date(playerState.oxygenUntil) : new Date(0),
            1800000, (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; }, undefined,
        ...
        [Actions.specificActions.STORE.BUY_BLACK_ROCK]: new DynamicPlayerAction("Buy Rock", "It's a strange looking black rock. There are odd markings on it. Nobody knows what its uses, or properties are...", 
            ...
            (playerState) => playerState.oxygenUntil ? new Date(playerState.oxygenUntil) : new Date(0),
            1800000, (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; },),
        [Actions.specificActions.STORE.BUY_BUBBLE_PASS]: new DynamicPlayerAction("Buy Bubble Pass", "This golden pass lets you access the Bubble Factory. It has no expiry date and can be used multiple times.", 
            ...
            (playerState) => playerState.oxygenUntil ? new Date(playerState.oxygenUntil) : new Date(0),
            2400000, (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; },),
        [Actions.ALL_UNDERWATER.STORE_OXYGEN]: new PlayerAction("Store Oxygen", "Store all your Oxygen (except 2 mins, enough for you to resurface) into your Oxygen Pump.", 
            "No task required.", "870px", "488px", undefined,
            (playerState) => playerState.storedOxygen !== null && playerState.challengeMode !== null),
        [Actions.ALL_UNDERWATER.WITHDRAW_OXYGEN]: new PlayerAction("Withdraw Oxygen", "Withdraw all Oxygen from your Oxygen Pump.", 
    ...
    [Locations.locationIds.TUNA]: {
        ...
        [Actions.ALL_OXYGEN.GET_OXYGEN]: new DynamicPlayerAction("Get Oxygen", "There is a large Oxygen Stream here, however, it has fallen into disrepair. Getting Oxygen from here will be slightly more challenging, but you can still expect to get 30 minutes of Oxygen here.",
    ...
    [Locations.locationIds.UMBRAL]: {
        [Actions.specificActions.UMBRAL.EXPLORE]: new DynamicPlayerAction("Explore", "This is a shady, run-down area. Apparently it used to be a residential district, but the Oxygen Stream here vanished one day, suddenly. You shudder as you walk around the area.", 
            ...
            (playerState) => playerState.oxygenUntil ? new Date(playerState.oxygenUntil) : new Date(0),
            300000, (setIsVisible, setIsEnabled): void => { setIsEnabled(false); }, (): void => { return; },),
        [Actions.specificActions.UMBRAL.GIVE_PAN]: new PlayerAction("Show Pyrite Pan", "Show Alyusi the Pyrite Pan.", 
            "Give 1 x Pyrite Pan.", "579px", "197px", undefined,
        ...
        [Actions.specificActions.UMBRAL.GIVE_ROCK]: new PlayerAction("Give Rock", "Give Alyusi the Chmyrrkyth.", 
            "Give 1 x Mysterious Black Rock.", "749px", "177px", undefined,
